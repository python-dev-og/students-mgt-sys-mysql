...
class DatabaseConnection:
    def __init__(self, host="localhost", user="root", password="admin123", database="school"):
        self.host = host
        self.user = user
    ...
    def connect(self):
        connection = mysql.connector.connect(host=self.host, user=self.host,
...
class EditDialog(QDialog):
    def __init__(self):
        ...
        # Add student's mobile number widget
